...
```{r,echo = FALSE}
details::details("`slackr::teams` is an `R6` object that manages multiple Slack teams. The object queries the [slackr-app](https://github.com/yonicd/slackr-app) database to set the environment variables needed by slackr, ",summary = 'teams',lang = NULL,open = TRUE)
```
